...
if(!isset($_SESSION["username"])){
        header('location:/Onyil/Yonetici/login');
    }
?>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a class="dropdown-item" href="/Onyil/Yonetici/logout">Güvenli Çıkış</a></li>
                            </ul>
                        </div>
                    ...
                    <li>
                        <a href="/Onyil/Yonetici/index"><i class="fa fa-diamond"></i> <span class="nav-label">Anasayfa</span></a>
                    </li>
                    <li class="active">
                        <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Sayfa Kategori</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="/Onyil/Yonetici/sayfalistesi?id=1">Sayfa Listesi</a></li>
                            <li><a href="#">Kategori Listesi</a></li>
                            <li><a href="#">Blog Listesi</a></li>
